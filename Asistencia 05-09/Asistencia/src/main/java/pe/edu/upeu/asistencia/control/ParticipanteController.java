...
public class ParticipanteController {
    ...
    public void initialize(){
        ...
        definirColumnas();
        //cbxTipoParticipante.getSelectionModel().selectFirst();
        listaParticipante();
    }
    ...
    public void listaParticipante(){
        ...
        carreraCol.setCellValueFactory(cellData ->new SimpleStringProperty(cellData.getValue().getCarrera().toString()));//puede ser con  NAME o con ToString
    ...
    public void editarParticioante(Participante p, int index){
